...
> React DnD is a set of React utilities to help you build complex drag and drop interfaces while keeping your components decoupled. ([React DnD overview](https://react-dnd.github.io/react-dnd/docs/overview))
